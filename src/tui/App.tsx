    ...
    <Layout hints={hints}>
      {(() => {
        switch (screen) {
          ...
          case 'scaffold':
            return <ScaffoldScreen onBack={back} />;
          case 'audit':
            return <AuditScreen onBack={back} />;
          case 'sync':
            return <SyncScreen onBack={back} />;
          case 'query':
            return <QueryScreen onBack={back} />;
          case 'recommend':
            return <RecommendScreen onBack={back} />;
          case 'validate':
            return <ValidateScreen onBack={back} />;
          case 'install':
            return <InstallScreen onBack={back} />;
        }
      })()}
    </Layout>
  );
